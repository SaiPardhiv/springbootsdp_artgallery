...
<table>
    ...
    <tr>
        ...
        <td><%= v.getVisitor_fullname() %></td>
    </tr>
    <tr>
        <td><strong>Email Address</strong></td>
        <td><%= v.getVisitor_email() %></td>
    </tr>
    <tr>
        <td><strong>Gender</strong></td>
        <td><%= v.getVisitor_gender() %></td>
    </tr>
    <tr>
        <td><strong>Contact</strong></td>
        <td><%= v.getVisitor_contact() %></td>
    </tr>
    <tr>
        <td><strong>Age</strong></td>
        <td><%= v.getVisitor_age() %></td>
    </tr>
</table>

<!-- Button to update profile -->
<div class="buttons">
   <a href="updatevisitor"><button >Update Profile</button></a> 
</div>
<br/><br/>
</body>
</html>
